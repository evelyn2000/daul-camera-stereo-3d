...
public class Texture2dProgram {
    ...
    public enum ProgramType {
        TEXTURE_2D, TEXTURE_EXT, TEXTURE_EXT_3D, TEXTURE_EXT_BW, TEXTURE_EXT_FILT
    }
    ...
    private static final String FRAGMENT_SHADER_EXT_3D = 
			 "#extension GL_OES_EGL_image_external : require\n" +
			 "precision highp float;\n" +
			 "varying vec2 vTextureCoord;\n" +
			 "uniform vec4 uOddOffset;\n" +
			 "uniform int uLeftOrRight;\n" +
			 "uniform samplerExternalOES sTexture;\n" +
			 "void main() {\n" +
			 "  gl_FragColor = texture2D(sTexture, vTextureCoord);\n" +
			 "}\n";
...
//            "}\n";
    ...
    private int muOddOffsetHandle;
	private int muLeftOrRightHandle;
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        switch (programType) {
            ...
            case TEXTURE_EXT_3D:
            	mTextureTarget = GLES11Ext.GL_TEXTURE_EXTERNAL_OES;
                mProgramHandle = GlUtil.createProgram(VERTEX_SHADER, FRAGMENT_SHADER_EXT_3D);
            	break;
            case TEXTURE_EXT_BW:
                mTextureTarget = GLES11Ext.GL_TEXTURE_EXTERNAL_OES;
        ...
        if(programType == ProgramType.TEXTURE_EXT_3D){
	        muLeftOrRightHandle = GLES20.glGetUniformLocation(mProgramHandle, "uLeftOrRight");        
	        muOddOffsetHandle = GLES20.glGetUniformLocation(mProgramHandle, "uOddOffset");
        } else {
        	muLeftOrRightHandle = -1;
        	muOddOffsetHandle = -1;
        }
    ...
    public void draw(float[] mvpMatrix, float[] texLeftMatrix, int leftTextureId, Drawable2d leftDrawable, 
    		float[] texRightMatrix, int rightTextureId, Drawable2d rightDrawable){
